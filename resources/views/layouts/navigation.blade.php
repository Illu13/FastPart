...
<nav class="lg:hidden botondropdown">
    ...
    <div id="dropdown" class="z-10 hidden divide-y divide-gray-100 rounded-lg shadow w-full justify-center items-center">
        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200 w-full" aria-labelledby="dropdownDefaultButton">
            ...
            <li>
                <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Motor</a>
            </li>
            <li>
            ...
            <li>
                <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Motos</a>
            </li>
            <li>
